<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="xmList" border @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="项目名称" align="center" prop="xmmc" />
      <el-table-column label="立项时间" align="center" prop="lxsj" >
      </el-table-column>
      <el-table-column label="录入时间" align="center" prop="time" >
      </el-table-column>
...
<script>
import { listXm, getXm, delXm, addXm, updateXm, exportXm, importTemplate } from "@/api/hbzy/xm";
...
export default {
  ...
  data() {
    return {
      ...
      upload: {
        ...
        // 上传的地址
        url: process.env.VUE_APP_BASE_API + "/hbzy/xm/importData"
      },
    };
  },
  created() {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有项目基本信息数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
